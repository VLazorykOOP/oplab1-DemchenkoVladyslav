...
namespace Task2 {
	...
	namespace alg1
	{
		...
		double T(double x, string filename)throw (exceptions::toalg4)
		{
			try
			{
		...
		double T(double x)throw (exceptions::toalg4)
		{
			try
			{
				if (abs(x) <= 1)
		...
		double srz(double x, double y, double z) throw (exceptions::toalg4)
		{
			if (x > y)
				return T(x) + U(z) - T(y);
			return T(y) + U(y) - U(z);
		}
		double srs(double x, double y, double z) throw (exceptions::toalg2, exceptions::toalg3, exceptions::toalg4)
		{
			if (z > y && z * z + x * y > 0)
		...
		double qrz(double x, double y)throw (exceptions::toalg2, exceptions::toalg3, exceptions::toalg4)
		{
			if (x > -1 && x < 1)
				return x * srs(x, y, x);
			return y * srs(y, x, y);
		}
		double rrz(double x, double y, double z)throw (exceptions::toalg2, exceptions::toalg3, exceptions::toalg4)
		{
			if (x > y)
				return x * z * qrz(y, z);
			return y * x * qrz(x, y);
		}
		double grs(double x, double y, double z)throw (exceptions::toalg4)
		{
			try {
